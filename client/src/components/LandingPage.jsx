...
import { Shield, Activity, MapPin, MessageSquare, Phone, ChevronRight, CloudRain, AlertTriangle } from '../icons/Icons';

// Make sure Leaflet is loaded globally via script in index.html or imported separately
// Example: <script src="https://unpkg.com/leaflet/dist/leaflet.js"></script>
      ...
      activeLocations.forEach((loc, index) => {
        const icon = L.divIcon({
          ...
          html: `<div class="relative w-4 h-4">
                  <div class="absolute inset-0 ${index === 3 ? 'bg-red-500' : 'bg-blue-500'} rounded-full animate-ping opacity-75" style="animation-delay: ${index * 0.5}s"></div>
                  <div class="relative w-4 h-4 ${index === 3 ? 'bg-red-500' : 'bg-blue-500'} rounded-full border-2 border-white shadow-lg"></div>
                 </div>`,
          iconSize: [16, 16]
        });
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20 items-center">
            <div className="flex items-center cursor-pointer" onClick={() => navigate('/')}>
              ...
              <span className="text-xl font-bold text-slate-900 tracking-tight">FloodGuard AI</span>
            </div>
            <div className="flex items-center space-x-6">
              <a href="tel:911" className="hidden md:flex items-center text-red-600 font-bold text-sm bg-red-50 px-4 py-2 rounded-full hover:bg-red-100 transition-colors border border-red-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-slate-500 mb-10 leading-relaxed max-w-2xl mx-auto">
              Equipping communities with AI-driven insights, real-time evacuation routes, and offline-first safety tools when it matters most.
            </p>
            
            <div className="flex flex-col sm:flex-row justify-center gap-4 mb-20">
              <button 
                onClick={() => navigate('/login')} // may babaguhin na logic
            ...
            <div className="relative mx-auto max-w-5xl rounded-2xl shadow-2xl bg-white rotate-x-12 transform-gpu overflow-hidden aspect-[16/9] z-20">
              <div ref={mapRef} className="w-full h-full bg-white"></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="group">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-3">AI Safety Assistant</h3>
              <p className="text-slate-500 leading-relaxed">
                Powered by Gemini 2.5, receive instant, context-aware safety guidance and evacuation protocols tailored to your specific location and situation.
              </p>
            </div>
            <div className="group">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-3">Live Evacuation Maps</h3>
              <p className="text-slate-500 leading-relaxed">
                Real-time routing to the nearest safe zones. Our maps update dynamically based on flood levels and road accessibility reports.
              </p>
            </div>
            <div className="group">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-3">Community Intelligence</h3>
              <p className="text-slate-500 leading-relaxed">
                Crowdsourced incident reporting allows residents to flag hazards, creating a living map of the disaster zone for faster authority response.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="py-20 bg-slate-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="md:w-1/2">
            ...
            <h2 className="text-4xl font-bold mb-6 leading-tight">No Internet? <br/>No Problem.</h2>
            <p className="text-slate-300 text-lg mb-8 max-w-md">
              Disasters often mean connectivity loss. FloodGuard automatically switches to a low-bandwidth Emergency Mode to keep critical contacts and cached maps available.
            </p>
            <button 
              onClick={() => navigate('/login')}
            ...
            <div className="bg-slate-800 p-8 rounded-3xl border border-slate-700 shadow-2xl max-w-sm w-full relative">
              ...
              <div className="space-y-4">
                <div className="bg-red-500/10 p-4 rounded-xl border border-red-500/20">
                  <h4 className="font-bold text-red-400 mb-1">Emergency Hotline</h4>
                  <p className="text-2xl font-bold">911</p>
                </div>
                <div className="bg-slate-700/50 p-4 rounded-xl border border-slate-600">
                  <h4 className="font-bold text-slate-300 mb-1">Nearest Safe Zone</h4>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center mb-4 md:mb-0">
              ...
              <span className="text-slate-900 font-bold text-lg">FloodGuard AI</span>
            </div>
          ...
          <div className="mt-8 text-center text-slate-400 text-sm">
            &copy; {new Date().getFullYear()} FloodGuard AI Response System. Built for resilience.
          </div>
        </div>
      </footer>
    </div>
